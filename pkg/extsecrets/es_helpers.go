...
// KeyAndProperty returns the remote-ref key and property behind a secret key.
...
// SecretLocation returns a stable identity string for a data entry. The backend is
// a parameter because the ExternalSecret does not carry it.
