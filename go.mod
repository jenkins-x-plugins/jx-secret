...
require (
	...
	github.com/chrismellard/secretfacade v0.0.8
...
replace github.com/chrismellard/secretfacade => github.com/jenkins-x-plugins/secretfacade v0.0.8-0.20210126070537-441e69bb87d7
