...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-secret/main/3'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-secret:0.1.53'
